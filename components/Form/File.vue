<template>
  <div class="file">
    <input :id="id" type="file" class="file__control" @change="handleFile" />
    <label :for="id" class="file__label">
      <svg
        width="16"
        height="16"
        viewBox="0 0 16 16"
