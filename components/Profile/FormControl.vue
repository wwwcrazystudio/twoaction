<template>
  <div class="profile-control">
    <div class="profile-control__label">{{ label }}</div>
    <div class="profile-control__wrap">
      <FormInput :type="type" :value="value" :label="label" :readonly="!edit" :show-label="false"
        @input="handleInput($event)" />

      <button class="profile-control__btn" @click="edit = !edit">
        <svg v-if="!edit" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-else width="12" height="12" viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
