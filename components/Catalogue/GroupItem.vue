<template>
  <li class="group-item">
    <div class="group-item__wrap">
      ...
      <h2 class="group-item__title">Business marketing</h2>

      <div class="group-item__cat">кино и игры</div>

      <div class="group-item__count"><var>1 268 846</var> подписчика</div>

      <div class="group-item__excerpt">
        Группа посвященная творению компаний Marvel и DC. Также любим обозревать
        другие киношедевры.
      </div>
